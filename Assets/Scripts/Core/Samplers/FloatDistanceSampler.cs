...
namespace ChaseMacMillan.CurveDesigner
{
    ...
    public class FloatDistanceSampler : ValueDistanceSampler<float, FloatSamplerPoint,FloatDistanceSampler>
    {
        ...
        public FloatDistanceSampler(string label,float defaultValue,Curve3DEditMode editMode,float minValue = float.NegativeInfinity, float maxValue = float.PositiveInfinity): base(label, editMode)
        {
