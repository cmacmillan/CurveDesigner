...
{
    [System.Serializable]
    public class NewExtrudeSampler : Sampler<BezierCurve>
    {
        public NewExtrudeSampler(string label, Curve3DEditMode editMode) : base(label,editMode) { }

        public NewExtrudeSampler(NewExtrudeSampler objToClone, bool createNewGuids,Curve3D curve) : base(objToClone,createNewGuids,curve) { }
