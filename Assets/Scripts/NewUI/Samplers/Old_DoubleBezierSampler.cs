...
{
    [System.Serializable]
    public class BezierCurveDistanceValue : CurveTrackingValue, ISelectEditable<BezierCurveDistanceValue>
    {
        [NonSerialized]
        public Old_DoubleBezierSampler _owner;
        public BezierCurve secondaryCurve;
        public BezierCurveDistanceValue(Old_DoubleBezierSampler owner,float distance,BezierCurve curve,BezierCurve curveToCopy) : base(distance, curve)
        {
            _owner = owner;
        ...
        public BezierCurveDistanceValue(BezierCurveDistanceValue objToClone,Old_DoubleBezierSampler newOwner) : base (objToClone)
        {
            _owner = newOwner;
    ...
    [System.Serializable]
    public class Old_DoubleBezierSampler : ISerializationCallbackReceiver, IActiveElement
    {
        ...
        public Old_DoubleBezierSampler()
        {

        }
        public Old_DoubleBezierSampler(Old_DoubleBezierSampler objToClone)
        {
